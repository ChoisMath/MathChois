# 2022 개정 수학과 교육과정 MAP (일반계 핵심 과목)

> 출처: 교육부 고시 「2022 개정 수학과 교육과정」. 문항 등록 시 과목·대단원·소단원·성취기준 분석의 기준 문서.
> 추출 범위: 공통수학1·2, 대수, 미적분Ⅰ·Ⅱ, 확률과 통계, 기하.

## 공통수학1

### 다항식
- 소단원(내용 요소): 다항식의 연산, 나머지정리, 인수분해
...
### 방정식과 부등식
- 소단원(내용 요소): 복소수와 이차방정식, 이차방정식과 이차함수, 여러 가지 방정식과 부등식
...
### 도형의 방정식
- 소단원(내용 요소): 평면좌표, 직선의 방정식, 원의 방정식, 도형의 이동
...
| [10공수2-01-07] | 원점, 축, 축, 직선 에 대한 대칭이동을 탐구하고, 실생활과 연결 하여 문제를 해결할 수 있다. |
...
| [10공수2-03-04] | 유리함수   의 그래프를 그릴 수 있고, 그 그래프의 성질을 탐구 할 수 있다. |
| [10공수2-03-05] | 무리함수  의 그래프를 그릴 수 있고, 그 그래프의 성질을 탐구할 수 있다. |

## 대수

### 지수함수와 로그함수
- 소단원(내용 요소): 지수와 로그, 지수함수와 로그함수
...
### 수열
- 소단원(내용 요소): 등차수열과 등비수열, 수열의 합, 수학적 귀납법
...
| [12대수03-05] | 여러 가지 수열의 첫째항부터 제항까지의 합을 구하는 방법을 설명할 수 있다. |
...
### 미분법
- 소단원(내용 요소): 여러 가지 함수의 미분, 여러 가지 미분법, 도함수의 활용
...
### 적분법
- 소단원(내용 요소): 여러 가지 함수의 적분법, 정적분의 활용
...
### 벡터
- 소단원(내용 요소): 벡터의 연산, 벡터의 성분과 내적, 도형의 방정식
